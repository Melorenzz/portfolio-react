       ...
       <section className='about' id='About'>
           <div className="container">
               ...
               <div className='about_columns'>
                   <Card link='#showcase' count={projects.length} title='TOTAL PROJECTS' description='Innovative web solutions crafted' />
                   <Card link='#showcase' count={certificates.length} title='CERTIFICATES' description='Professional skills validated' />
                   <Card link='#showcase' count='1' title='YEARS OF EXPERIENCE' description='Continuous learning journey' />
